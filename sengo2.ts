...
//% block="Sengo2 Vision Sensor" color="#ff6600" icon="\uf085"
//% block.loc.zh-cn="Sengo2视觉传感器"
//% block.loc.zh-tw="Sengo2視覺傳感器"
namespace Sengo2VisionSensor {
    ...
    function sengo2_SetParam(
        ...
        console.log("sengo2_SetParam " + param.toHex());
        return 0;
    }
    ...
    function sengo2_VisionSetStatus(
        ...
        console.log("sengo2_VisionSetStatus " + vision_type.toString());
        return 0;
    }
    ...
    function sengo2_GetValue(
        ...
        console.log("sengo2_GetValue " + vision_type.toString());
        return 0;
    }

    //% shim=tosee_sentry::sengo2_GetQrCodeValue
    function sengo2_GetQrCodeValue(): string {
        console.log("sengo2_GetQrCodeValue ");
        return "";
    }
     ...
     * Begin Sengo2.
     */
    //% blockId=Sengo2_begin block=" Initialize  Sengo2  port %mode |addr%addr "
     ...
     */
    //% blockId=Sengo2_led_set_color block=" Set  Sengo2  LEDs' color %detected_color|when targets were detected otherwise %undetected_color luma(1-15) %leval "
    ...
    /**
     * Sengo2 vision enable set.
     */
    //% blockId=Sengo2_vision_Set block=" Set  Sengo2  %enable  algo %vision_type "
    //% group="Settings Blocks"
    //% weight=98
     ...
     */
    //% blockId=Sengo2_vision_SetParamNum block=" Set  Sengo2  algo%vision_type   %max_num sets of params"
     ...
     * @param h ROI height.
     */
    //% blockId=Sengo2_vision_color_param block=" Set  Sengo2  algo Color  x-coord%x| y-coord%y| width%w| height%h| paramset%obj_id "
     ...
     */
    //% blockId=Sengo2_vision_blob_param block=" Set  Sengo2  algo Blob  min-width%w| min-height%h| color%l| paramset%obj_id "
    //% obj_id.min=1 obj_id.max=25 obj_id.defl=1
    //% w.defl=3
    //% h.defl=4
    ...
    /**
     * set vision Blob number.
     * @param vision_type: vision type.
     * @param mode max prama number.
     */
    //% blockId=Sengo2_vision_SetMaxBlobParam block=" Set  Sengo2  algo Blob  max num of blobs for each color(1-5)%mode"
    ...
    /**
     * set vision AprilTag number.
     * @param vision_type: vision type.
     * @param mode max prama number.
     */
    //% blockId=Sengo2_vision_SetMaxAprilTagParam block=" Set  Sengo2  algo AprilTag  standard%mode"
    //% group="Settings Blocks"
    //% weight=93
     ...
     * @param mode max prama number.
     */
    //% blockId=Sengo2_vision_SetMaxLineParam block=" Set  Sengo2  algo Line  max num of lines(1-5)%mode"
    //% mode.min=1 mode.max=5 mode.defl=1
    //% group="Settings Blocks"
    //% weight=92
     ...
     */
    //% blockId=Sengo2_get_color_value block="  Sengo2  algo Color   %object_info of result %obj_id" color="#2E8B57"
    //% inlineInputMode=inline
    ...
    /**
     * get vision sengo2_object_t data, this function will update vision sengo2_object_t automatically.
     * @param vision_type: vision type.
     * @param object_info:  object information
     * @param obj_id:  object index
     */
    //% blockId=Sengo2_get_value block="  Sengo2  algo%vision_type   %object_info of result %obj_id" color="#2E8B57"
    //% inlineInputMode=inline
    //% expandableArgumentMode="enabled"
    //% obj_id.min=1 obj_id.max=25 obj_id.defl=1
    //% group="Operation Blocks"
     ...
     * @param obj_id:  object index
     */
    //% blockId=Sengo2_get_Line_value block="  Sengo2  algo Line   %object_info of result %obj_id" color="#2E8B57"
    //% inlineInputMode=inline
    //% expandableArgumentMode="enabled"
    //% obj_id.min=1 obj_id.max=25 obj_id.defl=1
    //% group="Operation Blocks"
     ...
     * @param obj_id:  object index
     */
    //% blockId=Sengo2_get_qr_value block="  Sengo2  algo QrCode   %object_info of result %obj_id" color="#2E8B57"
    //% inlineInputMode=inline
    //% expandableArgumentMode="enabled"
    //% obj_id.min=1 obj_id.max=25 obj_id.defl=1
    //% group="Operation Blocks"
     ...
     */
    //% blockId=Sengo2_get_Qrcode_value_string block="  Sengo2  algo QrCode  string of decoding result" color="#2E8B57"
    //% inlineInputMode=inline
    //% expandableArgumentMode="enabled"
    //% obj_id.min=1 obj_id.max=25 obj_id.defl=1
    //% group="Operation Blocks"
     ...
     * @param obj_id:  object index
     */
    //% blockId=Sengo2_detected_color block=" Sengo2  algo Color  recognized %lable result %obj_id" color="#2E8B57"
    //% obj_id.min=1 obj_id.max=25 obj_id.defl=1
    //% group="Operation Blocks"
    //% weight=87
     ...
     * @param obj_id:  object index
     */
    //% blockId=Sengo2_detected_blob block=" Sengo2  algo Blob  detected %lable blob result %obj_id " color="#2E8B57"
     ...
     * @param obj_id:  object index
     */
    //% blockId=Sengo2_detected_card block=" Sengo2  algo Card  recognized %lable result %obj_id " color="#2E8B57"
    //% obj_id.min=1 obj_id.max=25 obj_id.defl=1
    //% group="Operation Blocks"
    //% weight=85
     ...
     * @param obj_id:  object index
     */
    //% blockId=Sentry_detected_class20 block=" Sengo2  algo 20Class  recognized %lable result %obj_id " color="#2E8B57"
    //% obj_id.min=1 obj_id.max=25 obj_id.defl=1
    //% group="Operation Blocks"
    //% weight=84
